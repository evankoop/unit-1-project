...
############################# TO DO #####################################
    ...
    product_revenue = """SELECT product_category, SUM(unit_price * quantity) FROM invoices GROUP BY product_category ORDER BY SUM DESC"""
############################# TO DO ####################################
...
############## CREATING CSV FILES FROM OUTPUTS #########################
    ...
    with open('product_revenue.csv', 'w') as file:
        ...
        print('Product revenue file created successfully!')
